<template>
  <div class="vux-header">
    <div class="vux-header-left">
      <a class="vux-header-back" @click.prevent="onClickBack" v-show="leftOptions.showBack">
                <span v-show="title"
                      :transition="transition">{{leftOptions.backText}}</span></a>
      <slot name="left"></slot>
    </div>
...
<style lang="less">
  ...
  .vux-header .vux-header-back > span,
